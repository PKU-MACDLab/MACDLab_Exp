...
"""autogenerated by genpy from ugv_ros/GoToActionResult.msg. Do not edit."""
import codecs
import sys
...
class GoToActionResult(genpy.Message):
  ...
  _type = "ugv_ros/GoToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ugv_ros/GoToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ugv_ros.msg.GoToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ugv_ros.msg.GoToResult()
