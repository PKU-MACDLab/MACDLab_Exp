...
"""autogenerated by genpy from ugv_ros/StopActionResult.msg. Do not edit."""
import codecs
import sys
...
class StopActionResult(genpy.Message):
  ...
  _type = "ugv_ros/StopActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ugv_ros/StopResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ugv_ros.msg.StopResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ugv_ros.msg.StopResult()
