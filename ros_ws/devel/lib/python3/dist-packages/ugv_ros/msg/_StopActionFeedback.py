...
"""autogenerated by genpy from ugv_ros/StopActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class StopActionFeedback(genpy.Message):
  ...
  _type = "ugv_ros/StopActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ugv_ros/StopFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = ugv_ros.msg.StopFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ugv_ros.msg.StopFeedback()
