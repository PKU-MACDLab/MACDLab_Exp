...
class StopActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StopFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StopActionFeedback(null);
    ...
    data.feedback = StopFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StopActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = StopFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new StopFeedback()
    }
...
module.exports = StopActionFeedback;
