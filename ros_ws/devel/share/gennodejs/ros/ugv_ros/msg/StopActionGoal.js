...
class StopActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StopGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StopActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = StopGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new StopGoal()
    }
