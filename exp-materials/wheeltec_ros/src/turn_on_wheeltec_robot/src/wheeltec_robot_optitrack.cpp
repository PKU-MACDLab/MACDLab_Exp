...
geometry_msgs::PoseStamped Opt_Pose;// instantiate an Optitrack object
/**************************************
...
void turn_on_robot::Opt_Callback(const geometry_msgs::PoseStamped &msg)
{
  Opt_Pose.pose.orientation.x=msg.pose.orientation.x;
  Opt_Pose.pose.orientation.y=msg.pose.orientation.y;
  Opt_Pose.pose.orientation.z=msg.pose.orientation.z;
  Opt_Pose.pose.orientation.w=msg.pose.orientation.w;
  Opt_Pose.pose.position.x=msg.pose.position.x;
  Opt_Pose.pose.position.y=msg.pose.position.y;
  Opt_Pose.pose.position.z=msg.pose.position.z;
}
...
void turn_on_robot::Control()
{
  ...
  while(ros::ok())
  {
    ...
    {
      Robot_Pos.X = Opt_Pose.pose.position.x;
      ...
      Robot_Pos.Y = Opt_Pose.pose.position.y;
      ...
      Robot_Pos.Z = atan2(2*(Opt_Pose.pose.orientation.w*Opt_Pose.pose.orientation.z+Opt_Pose.pose.orientation.x*Opt_Pose.pose.orientation.y),\
      (1-2*(Opt_Pose.pose.orientation.y*Opt_Pose.pose.orientation.y+Opt_Pose.pose.orientation.z*Opt_Pose.pose.orientation.z)));

      Mpu6050.orientation.w = Opt_Pose.pose.orientation.w;
      Mpu6050.orientation.x = Opt_Pose.pose.orientation.x;
      Mpu6050.orientation.y = Opt_Pose.pose.orientation.y;
      Mpu6050.orientation.z = Opt_Pose.pose.orientation.z;
...
turn_on_robot::turn_on_robot():Sampling_Time(0),Power_voltage(0)
{
  ...
  Opt_pose_sub = n.subscribe("/vrpn_client_node/wheeltec04/pose",100,&turn_on_robot::Opt_Callback, this);
